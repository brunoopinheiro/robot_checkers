...
dict_yolo_example = [{'name': 'green', 'class': 0, 'confidence': 0.92639, 'box': {'x1': 82.19824, 'y1': 242.47702, 'x2': 124.43007, 'y2': 277.96402}}, 
                     {'name': 'green', 'class': 0, 'confidence': 0.89701, 'box': {'x1': 391.77356, 'y1': 245.06636, 'x2': 427.38983, 'y2': 279.52399}}, 
                     {'name': 'green', 'class': 0, 'confidence': 0.88918, 'box': {'x1': 190.78366, 'y1': 145.63388, 'x2': 227.77084, 'y2': 181.99374}}, 
                     {'name': 'green', 'class': 0, 'confidence': 0.87085, 'box': {'x1': 340.96881, 'y1': 194.4679, 'x2': 375.68768, 'y2': 229.8226}}, 
                     {'name': 'green', 'class': 0, 'confidence': 0.84605, 'box': {'x1': 142.10675, 'y1': 191.16925, 'x2': 179.45728, 'y2': 225.12469}}, 
                     {'name': 'purple', 'class': 2, 'confidence': 0.82844, 'box': {'x1': 191.53006, 'y1': 35.45227, 'x2': 228.0199', 'y2': 293.01724, 'y1': 138.0175, 'x2': 326.03653, 'y2': 174.01268}}, {'name': 'purple', 'class': 2, 'confidence': 0.65843, 'box': {'x1': 300.3092, 'y1': 34.3768, 'x2': 333.14441, 'y2': 77.12195}}]
