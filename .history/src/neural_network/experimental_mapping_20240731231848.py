...
def verificar_localizacao(dicio, dicionario_kAnova, tolerancia=10):
    localizacoes = []
    ...
    for peca in dicio:
        ...
        for casa, coords in dicionario_kAnova.items():
...
# Exemplo de uso
resultados = verificar_localizacao(dicio, dicionario_kAnova)
