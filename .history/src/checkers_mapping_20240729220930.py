...
def coordenadas(casa_a1, dicionario_casas):
    ...
    for i in list('a3', 'a5', 'a7'):
        ...
        shift_x += 50
    for i in zip(list('b2', 'b4', 'b6', 'b8'), list('a3', 'a5', 'a7')):
        dicionario_casas[i][0] = dicionario_casas['a1'][2]
    dicionario_casas['b2'][0] = dicionario_casas['a1'][2]
    dicionario_casas['b4'][0] = dicionario_casas['a3'][2]
    dicionario_casas['b6'][0] = dicionario_casas['a5'][2]
    dicionario_casas['b8'][0] = dicionario_casas['a7'][2]
